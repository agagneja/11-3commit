...
public class ConnectionUtils {
    ...
    public static JSONObject createGift(String input,String account) {

        String postPath = buildPathForCreateGift();
        HttpPost httpPost = new HttpPost(postPath);
        Log.d("PATH", postPath);
        X_PAYPAL_SECURITY_CONTEXT = getSecutityContext(account);
    ...
    public static JSONObject fundingOptionsRequest(String id,String account) {
    ...
    public static JSONObject fulfillmentOptionsRequest(String id, String body,String account) {
    ...
    public static JSONArray getGifts(String account) {
        //String postPath = buildPathForFundingOptions(id);
        ...
        String security = getSecutityContext(account);
    ...
    public static JSONObject viewGift(String id,String account) {
    ...
    public static String getSecutityContext(String account)
    {
